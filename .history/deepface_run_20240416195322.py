...
class Detect_verify:
    ...
    def verify_faces(self):
        ...
        if self.detected_face:
            file_path = "dataset/verified.jpg"
            cv2.imwrite(file_path, self.frame)
            DeepFace.verify(img1_path = "dataset/verified.jpg", img2_path = "dataset/Photo on 16-04-24 at 11.50 AM.jpg", detector_backend = models[0])
            print("verified")
        return
